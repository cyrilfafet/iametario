      ...
      <section ref={heroRef} style={{ height: "500vh", position: "relative", marginTop: -navH, zIndex: 2 }}>
        ...
        <div style={{ position: "absolute", bottom: "25vh", left: "50%", transform: "translateX(-50%)", opacity: Math.max(0, 1 - p1 * 3), zIndex: 5, pointerEvents: p1 > 0.3 ? "none" : "auto" }}
          ...
          <div className="flex gap-6 items-center flex-wrap justify-center">
            <a href="https://www.instagram.com/etario_music" target="_blank" className="text-white/70 hover:text-white transition-colors">
            ...
            <a href="https://soundcloud.com/iametario" target="_blank" className="opacity-60 hover:opacity-100 transition-opacity" style={{ filter: "brightness(0) invert(1)" }}>
              <img src="/soundcloudlogo.png" alt="Soundcloud" className="h-10" />
            </a>
            <a href="https://open.spotify.com/intl-fr/artist/5PRHGYHjRAJsxSiHWuBUVp?si=QOFkWIr5Q12Fn2TDoBzlKg" target="_blank" className="text-white/70 hover:text-white transition-colors">
            ...
            <a href="https://youtube.com/@e-tario" target="_blank" className="text-white/70 hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>
          </div>
          <span className="hidden md:block text-white/30">|</span>
          <a href="#booking-form" onClick={() => setMenuOpen(false)} className="border border-white/50 text-white px-5 py-3 rounded-full text-xs font-semibold tracking-widest uppercase hover:border-white hover:bg-white/10 transition-colors">
            {t.booking_btn}
          </a>
        </div>{/* end social */}
